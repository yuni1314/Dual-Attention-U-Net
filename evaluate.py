...
model = M.DUA_UNet(input_size = (64,64,1))
model.summary()
model.load_weights('weight_Dual_2.hdf5')
...
jac_true = intersection / (union - intersection)
DSC = (2*intersection + 1e-6) / (union + 1e-6)
print("\nTrue Jaccard similarity score: " +str(jac_true))
print ("\nJaccard similarity score: " +str(jaccard_index))
print ("\nDSC score : " +str(DSC))
